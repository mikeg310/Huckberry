...
export default function Quote({ quote = "Gladly has transformed how we think about customer relationships.", author = "", authorTitle = "", company, authorImage, colorSchemeNew = "lightgrey" }: QuoteProps) {
    ...
    <section ref={ref} className={`${bgMap[colorSchemeNew] || bgMap.lightgrey} py-20 md:py-28`}>
      <div className={`container mx-auto px-4 sm:px-6 lg:px-8 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-5"}`}>
        <div className="max-w-3xl mx-auto text-center">
          {author && <svg className="w-10 h-10 mx-auto text-[#009b00] opacity-40 mb-6" viewBox="0 0 24 24" fill="currentColor"><path d="M4.583 17.321C3.553 16.227 3 15 3 13.011c0-3.5 2.457-6.637 6.03-8.188l.893 1.378c-3.335 1.804-3.987 4.145-4.247 5.621.537-.278 1.24-.375 1.929-.311 1.804.167 3.226 1.648 3.226 3.489a3.5 3.5 0 01-3.5 3.5c-1.073 0-2.099-.49-2.748-1.179zm10 0C13.553 16.227 13 15 13 13.011c0-3.5 2.457-6.637 6.03-8.188l.893 1.378c-3.335 1.804-3.987 4.145-4.247 5.621.537-.278 1.24-.375 1.929-.311 1.804.167 3.226 1.648 3.226 3.489a3.5 3.5 0 01-3.5 3.5c-1.073 0-2.099-.49-2.748-1.179z" /></svg>}
          <p className="text-2xl md:text-3xl font-semibold text-gray-900 leading-snug tracking-tight" style={{ fontFamily: "var(--font-display, 'Outfit', sans-serif)" }}>{quote}</p>
          {author && (
